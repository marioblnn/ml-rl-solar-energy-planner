...
class Device:
    ...
    def __init__(self, name: str, hourly_power_consumption_kwh: float, is_on: bool=False, smart_optimizer_enabled: bool=False, priority_window: PriorityWindow=None, daily_runtime_hours: int=0) -> None:
        self._name = name
