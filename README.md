...
<img width="1918" height="838" alt="pg1" src="https://github.com/user-attachments/assets/28e2a1e6-9a7f-4cfc-a8f9-0bcc933430ef" />
<img width="1437" height="838" alt="pg2" src="https://github.com/user-attachments/assets/10ddf47e-abd0-484e-be53-0794eea1f7e9" />
<img width="1452" height="402" alt="pg3" src="https://github.com/user-attachments/assets/50655a15-b4c9-4e2d-933c-b66cf7e90455" />
...
- Python 3.10+ 
- Internet access for Open-Meteo and package install
...
If the timesteps were modified run:
```bash
python trainRL.py
```
...
- **RL:** Gymnasiu, SmartHomeEnv, Stable-Baselines3 PPO, PyTorch
